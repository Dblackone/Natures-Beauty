...
(async () => {
  ...
  const input = path.join(root, 'simple-proposed-works-quote-ipoti-ayeni-franlin.html');
  const output = path.join(root, 'simple-proposed-works-quote-ipoti-ayeni-franlin.pdf');
